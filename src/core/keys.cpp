...
std::string MetaKey::toStr() const {
    ...
    if(Key_F12 <= k && k <= Key_F1) {
        ...
        ret += "pagedown";
    } else if(k == Key_ArrowLeft) {
        ret += "left";
    } else if(k == Key_ArrowRight) {
        ret += "right";
    } else if(k == Key_ArrowDown) {
        ret += "down";
    } else if(k == Key_ArrowUp) {
        ret += "up";
    } else if(k == Key_CtrlTilde) {
        ret += "~";
    ...
    } else if(k == Key_CtrlBackslash) {
        ret += "\\";
    } else if(k == Key_Ctrl6) {
        ret += "6";
    } else if(k == Key_CtrlUnderscore) {
        ret += "_";
    } else if(k == Key_Esc) {
        ret += "esc";
    } else if(Key_Space <= k && k <= Key_Tilde) {
        ret += (char)k;
    } else if(k == Key_Backspace2) {
        ret += "backspace";
    }
    return ret;
}
