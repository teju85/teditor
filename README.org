...
24. option to navigate/select this string vector through up/down arrows
25. support for highlighting the current selection while navigation through this string vector
