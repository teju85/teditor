...
25. option to navigate/select this string vector through up/down arrows
26. support for highlighting the current selection while navigation through this string vector
